...
<body>
    <img src="<?php echo base_url('assets/img/about_overlay.png') ?>">
    <!--::header part start::-->
                        ...
                        <div class="collapse navbar-collapse main-menu-item justify-content-end"
                            ...
                            <ul class="navbar-nav align-items-center">
                                <li class="nav-item active">
                                    <a class="nav-link" href="index.html">Login Siswa</a>
                                </li>
                                <li class="nav-item">
                ...
                <div class="col-lg-6 col-xl-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <!-- <h5>Selamat Datang Di Pendaftaran Peserta Perpustakaan SMK SUKAPURA</h5> -->
                            <P><H1>SELAMAT DATANG</P></H1> <H1><P>DI PENDAFTARAN PERPUSTAKAAN SMK SUKAPURA<H1></P>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        ...
                        <h4>Jumlah Semua Guru</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter">960</span>
                        <h4> Jumlah Seluruh Siswa</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
